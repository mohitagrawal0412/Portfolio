  ...
  return (
    <div className="canvas-container">
      ...
      <div className="social_icons">
        <FaFacebook className="text-white mt-5" size={30} />
        <FaInstagram className="text-white mt-5" size={30} />
        <FaLinkedinIn className="text-white mt-5" size={30} />
        <FaTwitter className="text-white mt-5" size={30} />
      </div>
