...
import { FaReact, FaNode, FaDocker } from "react-icons/fa6"; // Import all icons together
...
import { SiDataanalytics, SiAlgorithms, SiWebdevelopment } from 'react-icons/si';
...
const topics = [
    { src: <SiDataanalytics />, alt: 'Data Structures' },  // Data Structures icon
    { src: <SiAlgorithms />, alt: 'Algorithms' },            // Algorithms icon
    { src: <SiWebdevelopment />, alt: 'Web Development' },    // Web Development icon
];
