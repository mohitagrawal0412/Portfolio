...
const backendTechnologies = [
    [
        { src: Logo1, alt: 'Backend Logo 1' },
        { src: Logo2, alt: 'Backend Logo 2' },
    ],
...
const softwareTechnologies = [
    [
        { src: Logo1, alt: 'Software Logo 1' },
        { src: Logo2, alt: 'Software Logo 2' },
    ],
    // Add more technology rows as needed
];
...
const frontendTechnologies = [
    [
        { src: Logo1, alt: 'Frontend Logo 1' },
        { src: Logo2, alt: 'Frontend Logo 2' },
    ],
    // Add more technology rows as needed
];
