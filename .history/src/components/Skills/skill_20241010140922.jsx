...
import { FaJava, FaPython, FaCss3, FaHtml5, FaBootstrap, FaGithub, FaSass, FaDocker, FaReact } from "react-icons/fa6";
import { IoLogoNpm } from "react-icons/io";
import { SiTailwindcss, SiJquery, SiMysql, SiMongodb, SiSocketdotio, SiExpress } from "react-icons/si";
...
const softwareTechnologies = [
    ...
    [
        { src: <IoLogoNpm />, alt: 'npm' },{ src: <FaGithub />, alt: 'GitHub' },
    ]       // Git icon
];
...
const programmingTechnologies = [
    ...
    { src: <FaJsSquare />, alt: 'JavaScript' },  // JavaScript icon
            ...
            <div className="md:flex mt-20 text-center ml-10 mr-10 md:ml-36 md:mr-36">
                <div className="md:mr-20 md:w-1/3">
                    ...
                    <div className="relative mt-5 text-left">
                        ...
                        <TechnologySection title="DESAROLLO MÓVIL" technologies={programmingTechnologies} />
                    </div>
                </div>
            </div>
        </div>
