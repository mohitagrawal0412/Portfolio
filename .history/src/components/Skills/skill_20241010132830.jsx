...
const backendTechnologies = [
    [
        { src: "fa", alt: 'Backend Logo 1' },
        { src: "fa", alt: 'Backend Logo 2' },
    ],
...
const softwareTechnologies = [
    [
        { src: "fa", alt: 'Software Logo 1' },
        { src: "fa", alt: 'Software Logo 2' },
    ],
    // Add more technology rows as needed
];
...
const frontendTechnologies = [
    [
        { src: "fa", alt: 'Frontend Logo 1' },
        { src: "fa", alt: 'Frontend Logo 2' },
    ],
    // Add more technology rows as needed
];
